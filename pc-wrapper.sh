...
for v in ubuntu/bionic ubuntu/focal ubuntu/hirsute ubuntu/impish ubuntu/jammy debian/jessie debian/stretch debian/buster debian/bullseye debian/bookworm
do
    echo Pushing to $1/$v
